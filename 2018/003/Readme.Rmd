...
The proportion of ags production used to supprt gas LNG gas production and transoprt, the parasitic. load, is uncertain, and can be varied by changing the default value of 12% in  ```drake.R```
