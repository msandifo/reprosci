...
#  print(head(gasbb ))
 ...
 p01<- ggplot(gasbb.prod.zone.month, aes(gasdate, actualquantity-roma*parasitic.load.n))+
    geom_area(data=gasbb.prod.zone.month %>% subset(ZoneName=="Roma"),aes(y=-roma*parasitic.load.n), fill="green4", alpha=.75)+
